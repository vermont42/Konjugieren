...
struct Info: Hashable {
  ...
  static let infos: [Info] = [
    ...
    Info(heading: L.Info.tenseHeading, text: L.Info.tenseText),
    Info(heading: L.Info.moodHeading, text: L.Info.moodText),
    Info(heading: L.Info.voiceHeading, text: L.Info.voiceText),
