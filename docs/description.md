...
Master German verb conjugations with 3,371 verbs across all conjugationgroups—the definitive reference and quiz app for German learners.

FEATURES

Complete Conjugation Reference

Browse and search 3,371 German verbs with full conjugations across fifteen conjugationgroups:
...
Meistern Sie die deutsche Verbkonjugation mit 3.371 Verben in allen Konjugationsgruppen — die definitive Referenz- und Quiz-App für Deutschlernende.

FUNKTIONEN

Vollständige Konjugationsreferenz

Durchsuchen Sie 3.371 deutsche Verben mit vollständigen Konjugationen in fünfzehn Konjugationsgruppen:
